...
def app():
	...
	st.title("Meticulous Morose Detector"+"\n"+"Developed by: Shashwat Tiwari | Ayushi Sharma")


	activities=["Depression Detector","Generate Twitter Data"]

	choice = st.sidebar.selectbox("Select Your Activity",activities)



	if choice=="Depression Detector":

		st.subheader("Analyze the tweets of your concerned person")

		st.subheader("Enter the exact twitter handle of the concerned person (without @)")
		...
		Analyzer_choice = st.selectbox("Select the Activities",  ["Show Recent Tweets","Generate WordCloud" ,"Check Mental health via Tweet Analysis"])
